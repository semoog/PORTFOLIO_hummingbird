...
angular.module("meanmail").controller("masterCtrl", function($scope, $http, masterService, $state) {
    ...
    $('.login').on('submit', function(e) {
        e.preventDefault();
        openedWindow = window.open("http://localhost:80/auth/google", "Hummingbird Auth", "width=500px, height=500px, top=400, left=600");
        var $this = $(this),
    ...
    $scope.login = () => {
        ...
        return window.open("http://localhost:80/auth/google", "Hummingbird Auth");
